                ...
                <Stack
                        ...
                        <Link
                            onClick={() =>
                                window.utils.openExternal(
                                    "https://github.com/foryoung365/fluent-reader2/wiki/Support#keyboard-shortcuts"
                                )
                            }>
                    ...
                    <small>
                        <Link
                            onClick={() =>
                                window.utils.openExternal(
                                    "https://github.com/foryoung365/fluent-reader2"
                                )
                            }>
                    ...
                    <small>
                        <Link
                            onClick={() =>
                                window.utils.openExternal(
                                    "https://github.com/foryoung365/fluent-reader2/issues"
                                )
                            }>
