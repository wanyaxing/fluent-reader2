# MF RSS Reader v1.1.1 Release Notes
...
### 深色模式全面优化
- **全界面支持**：修复了在系统处于浅色模式时，应用内的深色模式设置无法正确应用到文章列表、设置界面和阅读界面的问题。
- **文章列表优化**：侧边栏和信息流网格现在可以完美响应深色主题，提供一致的视觉体验。
- **阅读界面修复**：修复了文章阅读界面背景不生效以及 AI 摘要区域显示不正常的问题。
- **设置界面视觉修正**：消除了设置界面中硬编码的白色背景，解决了开启深色模式后文字不可见的问题。
